...
function SideMenu() { 
	...
	return (
	  ...
	  <Sidebar collapsed={collapsed} className={style.sidebarpanel}>
		<div onClick={handleToggleSidebar} className={style.togglebutton}>
			<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-justify" viewBox="0 0 16 16">
				<path fill-rule="evenodd" d="M2 12.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5m0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5m0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5m0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5"/>
			</svg>
			
		</div> 
		<Menu className={style.menupanel}>
			<Link to="/predict" className={style.linkholder}>
				<MenuItem className={style.menuoption}>
			...
			<Link to="/train"  className={style.linkholder}>
				<MenuItem className={style.menuoption}>
			...
			<Link to="/adddisease"  className={style.linkholder}>
				<MenuItem className={style.menuoption}>
			...
			<Link to="/addmodel"  className={style.linkholder}>
				<MenuItem className={style.menuoption}>
			...
			<Link to="/managemodels"  className={style.linkholder}>
				<MenuItem className={style.menuoption}>
			...
			<Link to="/info"  className={style.linkholder}>
				<MenuItem className={style.menuoption}>
