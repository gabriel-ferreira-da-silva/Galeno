// src/components/navbar/Galnavbar.js
    ...
    return (
        <div className={style.navcontainer}>
            <div className={style.navholder}>
                <img src={galen} alt="Galen logo" />
                <h1>Galeno</h1>
            </div>

            <div className={style.navbarholder}>
                <Link to="/predict" className={style.navoption}>
                    <div>Predict</div>
                ...
                <Link to="/train" className={style.navoption}>
                    <div>Train</div>
                ...
                <Link to="/add-model" className={style.navoption}>
                    <div>Add Model</div>
                ...
                <Link to="/info" className={style.navoption}>
                    <div>Info</div>
